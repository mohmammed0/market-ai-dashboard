...
export default function AINewsPage() {
  ...
  return (
    <PageFrame
      ...
      description="تحليل الأخبار بالذكاء الاصطناعي المحلي — تحليل العناوين والمقالات بدون تأثير على باقي المنصة."
      eyebrow="AI Research"
      headerActions={<StatusBadge label={status?.effective_status === "ready" ? "AI جاهز" : "AI معطّل"} tone={status?.effective_status === "ready" ? "accent" : "warning"} />}
    >
      <FilterBar
      ...
      >
        <form className="analyze-form filter-form" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="form-actions">
            <button className="primary-button" type="submit" disabled={loading || !(status?.effective_status === "ready")}>
      ...
      <div className="panel result-panel">
        <SectionHeader
          title="AI Runtime"
          description="حالة الذكاء الاصطناعي لهذا المثيل."
        />
        {loadingStatus ? (
