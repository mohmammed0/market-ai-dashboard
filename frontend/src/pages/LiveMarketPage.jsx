...
export default function LiveMarketPage() {
  ...
  useEffect(() => {
    ...
    if (querySymbol && querySymbol !== normalizeSymbol(workspace?.active_symbol)) {
      updateWorkspaceState({ active_symbol: querySymbol }).catch(() => {});
    }
  ...
  useEffect(() => {
    ...
    const timer = window.setInterval(() => {
      loadTerminal(selectedSymbol, { refreshBootstrap: false, forceFresh: true }).catch(() => {});
    }, intervalMs);
