...
SIGNAL_REFRESH_MINUTES = max(1, min(int(os.getenv("MARKET_AI_SIGNAL_REFRESH_MINUTES", "3")), 15))
SIGNAL_CACHE_TTL_SECONDS = max(60, min(int(os.getenv("MARKET_AI_SIGNAL_CACHE_TTL_SECONDS", "300")), 1800))
SIGNAL_REFRESH_MAX_WORKERS = max(1, min(int(os.getenv("MARKET_AI_SIGNAL_REFRESH_MAX_WORKERS", "2")), 4))
